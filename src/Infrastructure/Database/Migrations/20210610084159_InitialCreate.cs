        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorIdentities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthorIdentities_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorIdentities_Languages_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorIdentities_AuthorId",
                table: "AuthorIdentities",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_AuthorIdentities_LanguageId",
                table: "AuthorIdentities",
                column: "LanguageId");
        }
